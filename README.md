[![Run App Vrisheek Panjala](https://github.com/Vrisheek8/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/Vrisheek8/GithubActions/actions/workflows/run-app.yaml)
